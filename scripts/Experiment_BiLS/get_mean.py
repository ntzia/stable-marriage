...
for d in sys.argv[1:]:
	...
	print(d + ":")
	fm = open("../../results/outputs/Experiment_BiLS/" + abbr[d] + 'mean', 'w')

	for file in os.listdir("../../results/outputs/Experiment_BiLS/"):
		...
		if file.startswith("out" + abbr[d] + "_"):
			...
			f = open("../../results/outputs/Experiment_BiLS/" + file, 'r')
			counters = {}
			times = {}
			ECosts = {}
			SECosts = {}
