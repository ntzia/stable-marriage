...
public class CaC_SEOpt extends Abstract_SM_Algorithm
{
    private int[][] nIndex, mIndex;
    int initialRounds;

    public CaC_SEOpt(int n, String menFileName, String womenFileName, int initRounds)
    {
    ...
    private int getCC()
    {
        ...
        for (int i = 0; i < n; i++)
        {
            if (mIndex[0][i] != Integer.MAX_VALUE) cnt++;
        }
        return cnt;
    }
    ...
    public int[] match()
    {
        ...
        while (!terminate())
        {
            ...
            {
                //System.out.println("Enforcing term: CC=" + getCC());
                finish_matching();
                break;
            }
    ...
    public static void main(String args[]) 
    {
        ...
        Abstract_SM_Algorithm smp = new CaC_SEOpt(n, menFile, womenFile, init*n);
