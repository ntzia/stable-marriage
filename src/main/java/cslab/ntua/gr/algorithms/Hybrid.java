...
public class Hybrid extends Abstract_SM_Algorithm
{
    private int[][] kappa;
    ...
    public Hybrid(int n, String menFileName, String womenFileName, int initRounds, String optCost)
    {
        super(n, menFileName, womenFileName);
        this.initialRounds = initRounds;
        this.cost_to_optimize = optCost;
    }

    // Constructor for when agents are available
    public Hybrid(int n, Agent[][] agents, int initRounds, String optCost)
    {
        super(n, agents);
        this.initialRounds = initRounds;
        this.cost_to_optimize = optCost;
    ...
    private int[][] finish_matching()
    {
        ...
        if (m1.hasBetterSE(m2)) return kappaSaved;
        else return kappa;
    }
    ...
    public static void main(String args[]) 
    {
        ...
        Abstract_SM_Algorithm smp = new Hybrid(n, menFile, womenFile, init*n, opt_cost);
